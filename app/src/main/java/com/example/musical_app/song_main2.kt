...
class song_main2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_song_main2)
        ...
        val mediaPlayer: MediaPlayer = MediaPlayer.create(this, R.raw.filhaal)

        var btnplay = findViewById(R.id.btn_play1)as Button
        ...
        var like = findViewById(R.id.imageview14) as ImageView
