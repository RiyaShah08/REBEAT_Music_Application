...
class song_playlist : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val mediaPlayer: MediaPlayer = MediaPlayer.create(this, R.raw.shapeofyou)

        var btnplay = findViewById(R.id.btn_play3)as Button
        ...
        //like/dislike
        var like = findViewById(R.id.imageview12) as ImageView
