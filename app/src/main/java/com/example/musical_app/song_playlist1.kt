...
class song_playlist1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_song_playlist1)
        ...
        val mediaPlayer: MediaPlayer = MediaPlayer.create(this, R.raw.wedonttalk)

        var btnplay = findViewById(R.id.btn_play4) as Button
        ...
        //seekbar time and transformation
        ...
        //like/dislike
        var like = findViewById(R.id.imageView11) as ImageView
